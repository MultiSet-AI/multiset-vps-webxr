# Multiset SDK Vanilla Demo

A vanilla JavaScript demo application showcasing the Multiset Visual Positioning System (VPS) API for WebXR applications. This demo demonstrates AR localization using vanilla JavaScript, Three.js, and the [@multisetai/vps](https://www.npmjs.com/package/@multisetai/vps) SDK.
...
Edit `src/main.js` and update the `MultisetClient` configuration with your credentials:
...
examples/vanilla/
├── src/
│   └── main.js          # Main JavaScript file with AR logic
